...
#the rest is NA
rownames(R2_sign_df_comorbidities)[grep("Fus", rownames(R2_sign_df_comorbidities))] #NA
rownames(R2_sign_df_comorbidities)[grep("Parvi", rownames(R2_sign_df_comorbidities))] #"s__Parvimonas micra"
#rownames(R2_sign_df_comorbidities)[grep("oxytoca", rownames(R2_sign_df_comorbidities))] #"s__Klebsiella_A oxytoca"
...
rownames(R2_sign_df_comorbidities)[grep("fragilis", rownames(R2_sign_df_comorbidities))] #"s__Bacteroides fragilis"   "s__Bacteroides fragilis_A"
...
sel_species <- c("s__Parvimonas micra", "s__Klebsiella_A oxytoca", "s__Peptostreptococcus stomatis", "s__Bulleidia moorei",
                 "s__Clostridium_Q symbiosum", "s__Bacteroides fragilis", "s__Bacteroides fragilis_A", "s__Streptococcus constellatus",
...
#-------------------------------------------------------------------------------
#version with only anemia and weightloss; remove Klebsiella oxytoca and only keep B. fragilis A

R2_df <- R2_sign_df_comorbidities[sel_species,]
FDR_df <- Q_sign_df_comorbidities[sel_species,]

sel_species <- c("s__Parvimonas micra", "s__Peptostreptococcus stomatis", "s__Bulleidia moorei",
                 "s__Clostridium_Q symbiosum", "s__Bacteroides fragilis_A", "s__Bacteroides fragilis", "s__Streptococcus constellatus",
                 "s__Granulicatella adiacens")
...
sel_species <- c("s__Parvimonas micra", "s__Peptostreptococcus stomatis", "s__Bulleidia moorei",
                 "s__Clostridium_Q symbiosum", "s__Bacteroides fragilis", "s__Bacteroides fragilis_A", 
                 "s__Streptococcus constellatus", "s__Granulicatella adiacens")
...
#                                   CRC_R2       CRC_Q
#s__Bacteroides fragilis        7.519723e-03 0.119291636
#s__Bacteroides fragilis_A      1.191454e-05 0.966416585
#s__Bulleidia moorei                      NA          NA
#s__Clostridium_Q symbiosum     2.351832e-02 0.002542916
...
#s__Parvimonas_micra s__Peptostreptococcus_stomatis            s__Bulleidia_moorei     s__Clostridium_Q_symbiosum 
#         0.002                          0.288                          0.481                          0.001 
#s__Bacteroides_fragilis      s__Bacteroides_fragilis_A  s__Streptococcus_constellatus     s__Granulicatella_adiacens 
#         0.117                          0.926                          0.002                          0.733 

ZicoSeq.obj$p.adj.fdr[sel_species_underscore] #only s__Clostridium_Q_symbiosum still
...
#0.015002015                    0.403818360                    0.600896765                    0.006290043                    0.213498428 
#s__Bacteroides_fragilis_A  s__Streptococcus_constellatus     s__Granulicatella_adiacens 
#0.956193080                    0.006582816                    0.795463854 


#s__Parvimonas_micra and s__Streptococcus_constellatus are added showing that they are very low abundant and low prevalence
#s__Parvimonas_micra, s__Clostridium_Q_symbiosum, s__Streptococcus_constellatus significant


table(clin_meta_sel$Elixhauser_Anemia)

table(clin_meta_sel$Elixhauser_WeightLoss)
...
boxplot(comm["s__Clostridium_Q_symbiosum",] ~ clin_meta_sel$icd10_first_3_name) #elevated in CRC. Main one we can make a point of in the manuscript
...
#-------------------------------------------------------------------------------
#version with only anemia and weightloss from above; 
...
heatmap_plot <- draw(heatmap_plot, annotation_legend_list = list(lgd_r2, lgd_sig))
